...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = create_post($_SESSION['user_id'], $title, $description, $point_cost);
    if ($result === true) {
        $success = '技能服務發布成功！';
    } else {
        $error = $result;
                ...
                <div class="card shadow">
                    <div class="card-header">
                        <h3 class="card-title mb-0">
                            <i class="bi bi-plus-circle"></i> 發布技能服務
                        </h3>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($error)): ?>
                        ...
                        <form method="POST" action="create_post.php">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="6" 
                                          placeholder="詳細說明你的技能服務內容、適合對象、預計時間等..." required></textarea>
                            </div>
